...
Public Class PatientRecord_Edit
    ...
    'FORM LOAD EVENT
    Private Sub PatientRecord_Edit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If TxtFName.Text <> "" And TxtLName.Text <> "" And NumY.Text <> "" And NumM.Text <> "" And NumD.Text <> "" And TxtICPass.Text <> "" And TxtAddress1.Text <> "" And TxtAddress2.Text <> "" And TxtMNumber.Text <> "" And TxtEmail.Text <> "" And TxtWeight.Text <> "" And TxtHeight.Text <> "" And CBoxBlood.Text <> "" And TxtAllergies.Text <> "" Then
            ...
            If IsNumeric(NumY.Text) = True And IsNumeric(NumM.Text) = True And IsNumeric(NumD.Text) = True Then
                Try
                    ...
                    'SQL Command
                    cmdOLEDB.CommandText = "UPDATE [Patient] SET PatientFName = '" + TxtFName.Text + "', PatientLName = '" + TxtLName.Text + "', PAgeY = " + NumY.Text + ", PAgeM = " + NumM.Text + ", PAgeD = " + NumD.Text + ", ICPassword = '" + TxtICPass.Text + "', AddressLine1 = '" + TxtAddress1.Text + "', AddressLine2 = '" + TxtAddress2.Text + "', MobileNo = '" + TxtMNumber.Text + "', Email = '" + TxtEmail.Text + "', [Weight] = '" + TxtWeight.Text + "', [Height] = '" + TxtHeight.Text + "', [Blood Type] = '" + CBoxBlood.Text + "', Allergies = '" + TxtAllergies.Text + "' WHERE [PatientID] = '" + TransID + "';"
    ...
    'CLOSE FORM EVENT
    Private Sub PatientRecord_Edit_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
